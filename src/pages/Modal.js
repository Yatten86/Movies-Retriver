...
let Modal = ({title, image, dateRelease, overview}) => {
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-sm">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className=" justify-center relative p-6 flex-auto">
                                    <img className="flex object-scale-down h-48 w-96 ..." src = {image} alt=""/>
                                    <h3 className=" flex justify-center text-2xl font-semibold">Release date: {dateRelease}</h3>
                                    <p className="my-4 text-slate-500 text-lg leading-relaxed">{overview}</p>
                                </div>
                                {/*footer*/}
